...
- Dedicated Load Balancer: `custom url`. See _Configuration_ section to update settings.

The UI is protected by Basic Authentication, and the default credentials are listed in the _Configuration_ section.
...
- When using CloudHub 2.0 and RTF, you must enable _Last-Mile Security_ in the app's Ingress tab if you want to use HTTPS.
